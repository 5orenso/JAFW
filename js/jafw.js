            ...
            loader : function (target, action) {
                ...
                if (action == 'show') {
                    ...
                    if ($('#' + target + '_ajax_loader').length <= 0) {
                        ...
                        $('<div id="' + target + '_ajax_loader" class="box_round ajax_loader" style="background-image:url(\'/jafw/img/bg_000000_30.png\'); background-repeat:repeat; background-position:left top; padding:5px; display:none; position:absolute !important; top:0px; left:0px; width:' + ew + 'px; height:' + eh + 'px;"><img src="/jafw/img/ajax-loader.gif" /></div>').prependTo($('#' + target));
                    }
